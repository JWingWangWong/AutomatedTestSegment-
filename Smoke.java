// Created by Jordan Wong and modified by another anonymous user
package test;
...
public class Smoke{
	...
	public void Test() throws Exception {
		...
		// REMOVED PASSWORD AND EMAIL FOR SECURITY REASONS ON PUBLIC GIT
		if (isElementPresent(By.id("Passwd"))){
			// Email and password are on the same form.
			enterString("Email", "CLASSIFIED"); // Enter 'cmpt371testingemail' into email field.
			enterString("Passwd", "CLASSIFIED");
			click("signIn");
		}else{
			// Email and password are on separate forms.
			enterString("Email", "CLASSIFIED");
			click("next");
			enterString("Passwd", "CLASSIFIED");
			click("signIn");
		}
